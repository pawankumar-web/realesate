...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at 20% 50%, oklch(0.5 0.18 25 / 0.08) 0%, transparent 50%), radial-gradient(circle at 80% 50%, oklch(0.55 0.15 45 / 0.08) 0%, transparent 50%)' }} />
      ...
      >
        <div className="glass-strong rounded-3xl p-8 sm:p-10 border border-border">
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mx-auto mb-4">
              <Shield className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-3xl font-bold text-gradient-light">Create Account</h1>
            <p className="text-muted-foreground mt-2">Join our premium real estate platform</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-11 h-12 rounded-xl bg-foreground/5 border-border focus:border-primary/50"
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-sm font-medium">Phone <span className="text-muted-foreground/60">(optional)</span></Label>
              <div className="relative">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <div className="grid grid-cols-2 gap-2 p-1 rounded-xl bg-foreground/5 border border-border">
                  <button
                    type="button"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 pr-11 h-12 rounded-xl bg-foreground/5 border-border focus:border-primary/50"
